...
<head>
    ...
    <title>Alianza-test</title><!--begin::Primary Meta Tags-->
...
<div class="app-wrapper"> <!--begin::Header-->
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark" style="background-color: #0a53be !important"> <!--begin::Sidebar Brand-->
        <div class="sidebar-brand" style="background-color: #0d6efd !important"> <!--begin::Brand Link--> <a href="./index.html" class="brand-link"> <!--begin::Brand Image--> <img src="/dist/assets/img/alianza-logo.png" class="brand-image opacity-75 shadow"> <!--end::Brand Image--> <!--begin::Brand Text--> <!--end::Brand Text--> </a> <!--end::Brand Link--> </div> <!--end::Sidebar Brand--> <!--begin::Sidebar Wrapper-->
                ...
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open"> <a href="#" class="nav-link active">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item"> <a href="{{route('employee.index')}}" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                    <p>Empleados</p>
                                </a> </li>
                            <li class="nav-item"> <a href="{{route('position.index')}}" class="nav-link active"> <i class="nav-icon bi bi-circle"></i>
                                    <p>Cargos</p>
                                </a> </li>
                        </ul>
                    </li>
