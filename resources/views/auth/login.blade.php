...
<div class="container-fluid h-100">
    <div class="row h-100">
        ...
        <div class="col-md-8 left-section d-flex">
            ...
            <h1 class="text-start">Bienvenido a la mejor plataforma organizacional online</h1>
        ...
        <div class="col-md-4 right-section">
            <div class="form-container">
                <div class="text-center mb-4">
                    <img src="/dist/assets/img/alianza-logo.png" alt="Logo PsicoAlianza" style="width: 50%;">
                </div>
